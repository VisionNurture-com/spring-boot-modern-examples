...
⚠️ **1 回きりの標本です。**率 0.1 のアームで 10 本、率 0.5 のアームで 57 本というように、
...
| アーム | 率 | スループット | p50 | p95 | p99 | CPU/リクエスト | RSS 最大 |
|---|---|---:|---:|---:|---:|---:|---:|
...
**同じ `/work` 経路のまま `n` だけを 2000 → 20000 の 1 段変え、アームを A0 / A3 / A5 の 3 本に絞って 3 ラウンド**回しました。
...
| 1 ラウンドごとの生値 | `results/006-otel-cost/measurements/<アーム>_<ラウンド>.json` |
| 受信スパンの内訳 | `results/006-otel-cost/spans/<アーム>.txt` |
